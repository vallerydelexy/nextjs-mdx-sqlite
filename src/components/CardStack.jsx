...
const CardStack = () => {
  return (
    <div className="stack group grid [grid:stack]/[stack] perspective-[5000px] peer z-10">
      ...
      ">
        <p className="mt-0 text-5xl">Appearance is A Glimpse of The Unseen</p>
        <p className='pt-8 text-sm '>Rizki Aprita</p>
      ...
      <div className="
        ...
        after:whitespace-nowrap after:px-4 after:py-2 after:rounded-[4ch] after:opacity-0 
        after:transition-[opacity,transform] after:duration-250 after:ease-[ease]
